...
namespace HDDT_CTNS
{
    public partial class frmphhdtheoso : DevExpress.XtraEditors.XtraForm
    {
        public bool m_update;
        DataTable dt = new DataTable();
        public frmphhdtheoso()
        {
            InitializeComponent();
        ...
        void get_data()
        {
            ...
            dt = GetData.Get_InvoiceList(txtSodoc.Text, dateEdit1.DateTime.Month, dateEdit1.DateTime.Year, "InvoiceListErrA");
        ...
        private void cmdPhathanh_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int j = m_bd_indexdt; j <= m_kt_indexdt; j++)
                {
                    ...
                    m_XML = PhatHanh.phat_hanh_hoa_don(txtTensodoc.Text.Trim(), dt, j,j, dateEdit1.DateTime.Month, dateEdit1.DateTime.Year,"", dateEdit2.Text);
                    ...
                    {
                        //string ngay_ct0 = Connection.convert_date(dt.Rows[j]["ngay_ct0"].ToString().Substring(0, 10));
                    ...
                    {
                        MessageBox.Show("Chưa phát hành hóa đơn số thứ tự: " + dt.Rows[j]["stt_order"].ToString());
                        return;
                    }                    
                }
